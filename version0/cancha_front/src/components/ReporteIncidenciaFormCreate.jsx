...
export default function ReporteIncidenciaFormCreate({ token, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessAlert({ open: true, msg: "Reporte creado correctamente." });
      setTimeout(() => navigate("/reporte-incidencias"), 1200);
    } catch (err) {
      setError(err.message || "Error al crear el reporte de incidencia.");
    } finally {
      setEnviando(false);
    }
  };
      ...
      <div className="mb-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <h1 className="flex items-center text-2xl font-poppins font-bold text-azul-950">
            ...
            Registrar nuevo Reporte de Incidencia
          </h1>
        </div>
      </div>
        ...
        <div className="bg-white rounded-md-xl shadow-lg p-4 px-4 md:p-8">
          <div className="mb-6">
            ...
            <p className="font-light text-verde-600">
              Ingresa los datos y selecciona encargado y reserva.
            </p>
          </div>
