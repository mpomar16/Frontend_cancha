...
function DisciplinaFormEdit({ initialData = {}, onSubmit, token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirige automáticamente después del mensaje
      setTimeout(() => navigate("/disciplinas"), 1500);
    } catch (err) {
      setError(err.message || "Error al actualizar la disciplina.");
    } finally {
      setEnviando(false);
    }
  };
...
export default DisciplinaFormEdit;
