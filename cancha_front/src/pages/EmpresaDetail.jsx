  ...
  return (
    <Sidebar>
      <div>
        ...
        {localStorage.getItem('roles').includes('ADMINISTRADOR') && (
          <Link to={`/empresa/edit/${id}`} className="bg-azul-900 text-white px-4 py-2 rounded hover:bg-yellow-600 mt-4 inline-block">
            Editar Empresa
          </Link>
        )}
      </div>
