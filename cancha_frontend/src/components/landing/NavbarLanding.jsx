        ...
        <header className="fixed top-0 left-0 w-full bg-azul-950 dark:bg-azul-950 shadow-sm font-poppins z-50">
            <nav className="bg-azul-950 mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:gap-x-12 relative">
                        <a
                            href="#hero"
                            className="transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-verde-600 text-sm font-bold text-blanco-50"
                        >
                            Inicio
                        </a>
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-verde-600 flex items-center gap-x-1 text-sm font-bold text-blanco-50 dark:text-blanco-50"
                        >
                            Producto
                            <svg
                                viewBox="0 -1 20 20"
