...
router.post('/', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE']), crearPonderacion);

router.get('/', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), listarPonderaciones);
router.get('/:id', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), obtenerPonderacionPorId);
router.get('/:id/cliente', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), obtenerClientePorPonderacionId);
router.get('/:id/cancha', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), obtenerCanchaPorPonderacionId);
router.get('/cliente/:id_cliente', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE']), listarPonderacionesPorClienteId);
router.get('/cancha/:id_cancha', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), listarPonderacionesPorCanchaId);
router.get('/cancha/:id_cancha/promedio', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE', 'DEPORTISTA', 'ENCARGADO']), obtenerPromedioCalificacionPorCanchaId);
router.get('/cliente/:id_cliente/cancha/:id_cancha', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE']), obtenerPonderacionPorClienteYCancha);

router.patch('/:id', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE']), actualizarPonderacion);
router.delete('/:id', verifyToken, checkRole(['Administrador_ESP_DEPORTIVO', 'CLIENTE']), eliminarPonderacion);
