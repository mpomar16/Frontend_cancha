...
router.get('/', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), listarComentarios);
router.get('/:id', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), obtenerComentarioPorId);
router.get('/:id/cancha', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), obtenerCanchaPorComentarioId);
router.get('/:id/cliente', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), obtenerClientePorComentarioId);
router.get('/cancha/:id_cancha', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), listarComentariosPorCanchaId);
router.get('/cliente/:id_cliente', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE']), listarComentariosPorClienteId);
router.get('/estado/:estado', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE', 'ENCARGADO']), listarComentariosPorEstado);

router.patch('/:id', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE']), actualizarComentario);
router.delete('/:id', verifyToken, checkRole(['ADMINISTRADOR_ESP_DEPORTIVO', 'CLIENTE']), eliminarComentario);
